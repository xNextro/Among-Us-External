...
int main()
{
    ...
    // Kill Cooldown
    DWORD Killcdaddy = 0x01468910;
    vector<DWORD> Killcdoffsets{ 0x5C,0x0,0x44 };
    DWORD Killcd = NULL;
    ...
    //Impostor Vision
    DWORD imposvisionaddy = 0x01468910;
    ...
    // SkinChanger
    DWORD hSkinaddy = 0x014688CC;
    vector<DWORD> hSkinPointers{ 0x5C,0x24 };
    DWORD hSkin = NULL;
    ...
    DWORD charstateaddy = 0x01468910;
    vector<DWORD> charstatepointers{ 0x5C,0x0,0x34,0X28 };
    ...
    // ColorChanger
    DWORD hColaddy = 0x0014688C;
    vector<DWORD> hColPointers{ 0x5C,0x18 };
    DWORD hCol = NULL;
    ...
    //Respawn (update the offsets for this hack/ isDead
    ...
    //LocalPlayerName
    DWORD lPlayerNameaddy = 0x014688CC;
    vector<DWORD> lPlayerNamePointers{ 0x5C,0x4,0xC };
    ...
    // see impostor
    DWORD cimposter = gameBaseAddress1 + 0x0088BD88;
    DWORD bytes;
    ...
    DWORD cimpostervote = gameBaseAddress1 + 0x008DB589;
    DWORD bytes1;
